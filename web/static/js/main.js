...
var _user$project$Main$view = function (model) {
	var position = _elm_lang$core$Basics$toString(model);
	var message = _elm_lang$core$Native_Utils.eq(
		position,
		_elm_lang$core$Basics$toString(260)) ? 'CITY of ElmLANDO' : 'CITY of ORLANDO';
	return A2(
		_elm_lang$svg$Svg$svg,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$version('1.1'),
				_elm_lang$svg$Svg_Attributes$width('580'),
				_elm_lang$svg$Svg_Attributes$height('360'),
				_elm_lang$svg$Svg_Attributes$viewBox('0 0 580 360')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$xlinkHref('images/city_of_orlando.png'),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$xlinkHref('images/elm.png'),
						_elm_lang$svg$Svg_Attributes$x(position),
						_elm_lang$svg$Svg_Attributes$y('0'),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$x('115'),
						_elm_lang$svg$Svg_Attributes$y('295')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
...
var _user$project$Main$keyUp = F2(
	function (keyCode, model) {
		...
		switch (_p0.ctor) {
			case 'ArrowLeft':
				return {ctor: '_Tuple2', _0: model + 0, _1: _elm_lang$core$Platform_Cmd$none};
			case 'ArrowRight':
				return {ctor: '_Tuple2', _0: model + 0, _1: _elm_lang$core$Platform_Cmd$none};
			default:
...
var _user$project$Main$keyDown = F2(
	function (keyCode, model) {
		...
		switch (_p1.ctor) {
			case 'ArrowLeft':
				return {ctor: '_Tuple2', _0: model - 10, _1: _elm_lang$core$Platform_Cmd$none};
			case 'ArrowRight':
				return {ctor: '_Tuple2', _0: model + 10, _1: _elm_lang$core$Platform_Cmd$none};
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p2 = msg;
		if (_p2.ctor === 'KeyDown') {
			return A2(_user$project$Main$keyDown, _p2._0, model);
		} else {
			return A2(_user$project$Main$keyUp, _p2._0, model);
		}
	});
var _user$project$Main$init = {ctor: '_Tuple2', _0: 50, _1: _elm_lang$core$Platform_Cmd$none};
